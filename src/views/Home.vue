      ...
      <div class="card_father">
        <div class="card">
          ...
          <div
            ...
            :style="{
              backgroundImage:
                'url(' + require('@/assets/img/Card_1.png') + ')',
            }"
          >
            <div class="bg"></div>
          ...
          <div class="card_back">
            <div class="body_back">
              <h3>Vincúlate</h3>
              <p>
                Vincúlate a nuestro equipo registrando toda tu información en el
                formulario de registro
              </p>
              <router-link to="/Vinculate"
      ...
      <div class="card_father">
        <div class="card">
          ...
          <div
            ...
            :style="{
              backgroundImage:
                'url(' + require('@/assets/img/Card_2.png') + ')',
            }"
          >
            <div class="bg"></div>
            <div class="body_front">
          ...
          <div class="card_back">
            <div class="body_back">
              ...
              <p>
                Busca el profesional perfecto para resolver el incoveniente que
                presentas
              </p>
      ...
      <div class="card_father">
        <div class="card">
          ...
          <div
            ...
            :style="{
              backgroundImage:
                'url(' + require('@/assets/img/Card_3.png') + ')',
            }"
          >
            <div class="bg"></div>
            <div class="body_front">
          ...
          <div class="card_back">
            <div class="body_back">
              ...
              <p>
                Tu opinión es muy valiosa mejorando el portafolio profesional y
                para referencia de la comunidad.
              </p>
              <router-link to="/calificar"
                ><input type="button" value="Leer Más"
              /></router-link>
            </div>
          </div>
