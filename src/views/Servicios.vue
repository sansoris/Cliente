  ...
  <Basiclayouts>
    <div class="contenedor sombra">
      <main class="servicios">
        <div class="servicio">
          <router-link class="nav-link text-black" to="/recomendados">
            <h3>Plomería</h3>
          </router-link>

          <div class="iconos">
            <img
              src="@/assets/img/plomeria.png"
        ...
        <div class="servicio">
          ...
          <div class="iconos">
            <img
              src="@/assets/img/electricidad.png"
              style="width:150px;height:auto;"
            />
        ...
        <div class="servicio">
          ...
          <div class="iconos">
            <img
              src="@/assets/img/carpinteria.png"
              style="width:150px;height:auto;"
            />
            <!-- <xml version="1.0" encoding="utf-8">
        ...
        <div class="servicio">
          ...
          <div class="iconos">
            <img
              src="@/assets/img/electronicos.png"
              style="width:150px;height:auto;"
            />
            <!-- <xml version="1.0" encoding="utf-8">
        ...
        <div class="servicio">
          ...
          <div class="iconos">
            <img
              src="@/assets/img/albanileria.png"
              style="width:150px;height:auto;"
            />
            <!-- <xml version="1.0" encoding="utf-8">
