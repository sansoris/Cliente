    ...
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          ...
          <p>De conformidad con la Ley 1581 de 2012 (protección de datos personales) y mediante el registro del formulario de recomendación, autoriza la recolección, almacenamiento y uso de los datos allí solicitados, con la finalidad de adelantar el trámite de revisión de la información, así como para publicarlos en la plataforma, con el fin de ser contactado por futuros clientes que hagan uso de ella. <br>
          Como titular de información tiene derecho a conocer, actualizar y rectificar sus datos personales, solicitar prueba de autorización otorgada para su tratamiento, ser informado sobre el uso que se ha dado a los mismos, presentar quejas ante la SIC por infracción a la ley, revocar la autorización, solicitar la supresión de sus datos en los casos en que sea procedente y acceder en forma gratuita a los mismos. <br>
          ...
          <!-- pendiente vincular el pdf -->
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 padding_rl">
        <div class="about-box_img">
          <figure><img src="/img/civil01.jpg" alt="#"  /></figure>
        </div>
      </div>
    </div>
...
// keyboard:"boolean",slide:"(boolean|string)",pause:"(string|boolean)",wrap:"boolean"},W="next",F="prev",U="left",B="right",K={SLIDE:"slide"+x,SLID:"slid"+x,KEYDOWN:"keydown"+x,MOUSEENTER:"mouseenter"+x,MOUSELEAVE:"mouseleave"+x,TOUCHEND:"touchend"+x,LOAD_DATA_API:"load"+x+j,CLICK_DATA_API:"click"+x+j},V="carousel",Q="active",Y="slide",G="carousel-item-right",q="carousel-item-left",z="carousel-item-next",X="carousel-item-prev",J={ACTIVE:".active",ACTIVE_ITEM:".active.carousel-item",ITEM:".carousel-item",NEXT_PREV:".carousel-item-next, .carousel-item-prev",INDICATORS:".carousel-indicators",DATA_SLIDE:"[data-slide], [data-slide-to]",DATA_RIDE:'[data-ride="carousel"]'}
